...
<nav id="navbar" class="navbar">
    <ul>
        ...
        <!-- Tambahkan tautan untuk halaman login -->
        <li><a class="nav-link scrollto" href="/login">Login</a></li>
    </ul>
    <i class="bi bi-list mobile-nav-toggle"></i>
    <div class="navbar-nav ms-auto">
        <!-- Hapus tautan login yang sudah ada di sini -->
    </div>
</nav><!-- .navbar -->
      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Coffe Time Menara<span></span></h1>
            <h2>Jagonya kopi hitam, dengan biji kopi pilihan terbaik</h2>
        ...
        <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
          <img src="assets/img/64ab9d8c2c311.jpg" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
